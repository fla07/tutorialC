...
6 - Reescreva o programa do exercicio anterior retirando o vetor de estruturas
    deixando apenas uma estrutura simples. Escreva e leia os registros direto 
    no arquivo utilizando apenas esta estrutura. (utilize a funcao fseek).
*/
