...
troca(x,y)
int x,y;    /* recebe a copias dos valores das variaveis "a" e "b" da funcao 
               main */
{
int c;
...
float soma(x,y) /* na frente do <nome_da_funcao> esta' declarado o 
...
5 - Reescreva o programa do exercicio 4 de ponteiros, transformando a 
...
6 - Acrescente ao exercicio anterior as funcoes de procura, altera e exclui
